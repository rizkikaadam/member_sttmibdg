    ...
    <div class="outer">
        <div class="inner bg-light lter">
            ...
            <div class="col-lg-4">
                <div class="box">
                    <header>
                      <h5><i class="glyphicon glyphicon-home"></i>&nbsp;Foto Berita</h5>
                        <div class="toolbar">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Upload Foto Berita</h4>
            </div>
            <div class="modal-body">
                <p>
                  <form class="form-horizontal" method="post" action="<?= base_url() ?>Berita/update_foto" enctype="multipart/form-data">
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="text1" class="control-label col-lg-2"></label>
                          <div class="col-lg-8">
                            <input type="hidden" name="berita_id"  id="text1" placeholder="Isi Banyak Mahasiswa" class="form-control" value="<?php echo $id;?>">
                              <button type="submit" name="btn simpan" class="btn btn-primary">Simpan</button>
                          </div>
                      </div>
                  </form>

                              ...
                              <div class="col-lg-12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5><i class="glyphicon glyphicon-user"></i>&nbsp;Data artikel</h5>
                                            <div class="toolbar">
                                              <a data-toggle="modal" data-original-title="Help" data-placement="bottom"
                                                 href="artikel/tambah_artikel" class="btn btn-primary btn-sm btn-rect" >  <i class="glyphicon glyphicon-edit"></i> Tambah Data artikel</a>
                                            </div>
                                        </header>
                                        <div id="collapse4" class="body">
                                          <?php
                                          $jumlah_data=$artikel->num_rows();
                                          if ($jumlah_data==0) {
                                           ...
                                           ?>
                                            <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                ...
                                                <tbody>
                                                  <?php
                                                        //<td><img src='assets/gambar/$data_artikel->foto' width='100' /></td>
                                                        foreach ($artikel->result() as $data_artikel) {
                                                          echo "<tr>
                                                              <td>$data_artikel->artikel_id</td>
                                                              <td>$data_artikel->artikel_judul</td>";?>
                                                              <td ><img class="col-lg-4" src="<?php base_url()?>assets/gambar/<?php echo $data_artikel->artikel_foto; ?>" /></td>
                                                              <?php
                                                              echo"
                                              ...
                                              <?php }//akhir kondisi menghitung data artikel ?>
                                        </div>
                                    </div>
                                </div>
                            </div>

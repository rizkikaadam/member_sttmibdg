<div id="content">
    <div class="outer">
        <div class="inner bg-light lter">
            ...
            <div class="row">
                        <?php
                              //<td><img src='assets/gambar/$data_mahasiswa->foto' width='100' /></td>
                              foreach ($mahasiswa->result() as $data_mahasiswa) {
                                    ...
                                    $tmpt_lahir=$data_mahasiswa->tempat_lahir;
                                    $tgl_lahir=$data_mahasiswa->tanggal_lahir;
                              }// akhir menampilkan data mahasiswa
              ...
              <div class="col-lg-2">
                  <div class="box">
                      ...
                      <div class="body">
                          <img src="../admin_sttmibdg/assets/gambar/<?php echo $foto;  ?>" width="100%"  />
                      </div>
                  </div>
              </div>
              <div class="col-lg-10">
                    <div class="box">
                        <header>
                            ...
                            <div class="toolbar">
                              <a data-toggle="modal" data-original-title="Help" data-placement="bottom"
                                 href="<?php echo base_url(); ?>Mahasiswa/edit_mahasiswa/<?php echo "$nim"; ?>" class="btn btn-primary btn-sm btn-rect" >  <i class="glyphicon glyphicon-edit"></i> Edit Data mahasiswa</a>
                            </div>
                        </header>
                        <div id="collapse4" class="body">
                            <table class="table table-striped responsive-table">
                                    <tr>
                                        <td><i class="glyphicon glyphicon-user"></i> NIM  :</td>
                                        <td><?php echo "$nim"; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><i class="glyphicon glyphicon-user"></i> Prodi :</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                  <form class="form-horizontal" method="post" action="<?php echo base_url() ?>Mahasiswa/update_foto" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="text1" class="control-label col-lg-2"></label>
                          <div class="col-lg-8">
                            <input type="hidden" name="nim"  id="text1" placeholder="Isi Banyak Mahasiswa" class="form-control" value="<?php echo $nim;?>">

                        ...
                        <div id="collapse4" class="body">
                            <table class="table table-striped responsive-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                $mata_kuliah = explode(",", $mengajar);

                                                $jumData = count($mata_kuliah);  //untuk menghitung jumlah elemen array
                                                //print_r (explode(",",$mengajar));
                                                for($i=0;$i<$jumData;$i++){
                                                  print "<span class='label label-info'>".strtoupper($mata_kuliah[$i])."</span><br>";
                                               }

...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p>
              <form class="form-horizontal" method="post" action="<?= base_url() ?>Mahasiswa/ubah_password_proses" enctype="multipart/form-data">
              <?php
                foreach ($mahasiswa->result() as $data_mahasiswa) {
                  $password_lama=$data_mahasiswa->epass;
              ...
              ?>
                ...
                <input type="hidden" id="hidden" value="<?php echo $nim;?>"  name="nim" class="form-control" required="required">

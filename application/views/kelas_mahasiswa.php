                                    ...
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar">
                                              <a data-toggle="modal" data-original-title="Help" data-placement="bottom"
                                                 href="<?= base_url() ?>Kelas" class="btn btn-primary btn-sm btn-rect" >  <i class="glyphicon glyphicon-edit"></i> Cari Kelas</a>
                                            </div>
                                        </header>
                                        <div id="collapse4" class="body">
                                          ...
                                          if ($jumlah_data==0) {
                                           ...
                                           elseif ($pesan == "keluar") {
                                             echo "<p class='bg-info'><h1>Anda Berhasil Keluar Pada Salah Satu Kelas</h1></p>";
                                           }
                                           ?>
                                                ...
                                                <tbody>
                                                  <?php
                                                        ...
                                                        foreach ($kelas->result() as $data_kelas) {
                                                          echo "<tr>
                                                              <td>$data_kelas->id_member_kelas</td>
                                                              ...
                                                              <td>
                                                                ...
                                                                <a href='".base_url()."kelas/keluar_kelas/$data_kelas->id_member_kelas' class='btn btn-danger btn-sm'>  <i class='glyphicon glyphicon-log-out'></i>&nbsp;Keluar</a>
                                                              </td>
                                                          </tr>";
